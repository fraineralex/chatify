...
export function Header() {
  return (
    <header
      className="flex justify-center flex-col max-w-xl mx-auto items-center pt-12"
    >
      <h1 className="font-bold items-center mb-8 mt-4 flex gap-5 animate-fade-in-up z-10">
        ...
        <span className="align-middle">
          <ChatifyLogo className="text-sm me-0 text-brand flex origin-center transition-all ease-in-out h-36 w-36" />
        </span>
      </h1>
    </header>
  )
