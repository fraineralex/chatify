  ...
  return (
    <section className='flex flex-col max-w-4xl mx-auto mb-12 gap-12 mt-5 px-4 md:px-0'>
      <article className='flex flex-col items-center justify-center gap-10 md:flex-row'>
        ...
        >
          <img src='/hero-desktop.webp' alt='Screenshot of Chatify in use' className='rounded-2xl hidden md:block' loading='lazy' height={504} width={896} />
          <img src='/hero-mobile.webp' alt='Screenshot of Chatify in use' className='rounded-2xl block md:hidden' loading='lazy' height={720} width={720} />
        </div>
      </article>
    </section>
  )
