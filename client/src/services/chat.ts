...
export async function getChatById(chatId: string, userId: string | undefined): Promise<Chat | undefined> {
  try{
...
export async function createChat(user1Id: string | undefined, user2Id: string): Promise<Chat | undefined> {
  try {
...
export async function getAllChats(userId: string | undefined): Promise<Chat[] | undefined> {
  try {
